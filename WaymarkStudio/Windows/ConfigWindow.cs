...
public class ConfigWindow : Window
{
    ...
    public override void Draw()
    {
        ...
        needSave |= ImGui.Checkbox("Combine Equivalent Duty Presets (V&C Dungeons)", ref Configuration.CombineEquivalentDutyPresets);
        MyGui.HoverTooltip("Show V&C Dungeon presets in all forms of the content (variant, advanced, criterion, criterion savage).");
